...
if (!empty($_POST)) {
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'Project Leads - Hill Waves';
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="project-content">
						<h2>Invest in Hill Waves residential open plots situated near Yadagirigutta.
						</h2>
						<ul class="project-data-list">
							...
							<li>
								...
								<span class="data-text">
									<a href="assets/Broucher/hill_waves_brochure_.pdf"
				...
				<!-- <div class="col-md-6">
					<div class="section-image">
						<div class="feature-image">
							<img src="images/hill-waves-gallery-1.jpg" alt="project-img">
						</div>
					</div>
				</div> -->
				<div class="col-md-12">
