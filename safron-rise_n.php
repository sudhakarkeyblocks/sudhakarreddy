...
if (!empty($_POST)) {
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'Project Leads - Safron Rise';
...
<head>
	...
	<meta name="description" content="Buy residential land and open plots near shadnagar hyderabad. The Project is well connected by major roads like NH 65. Book now."/>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="project-content">
						<h2>Residential Land and Open Plots Near Shad Nagar Hyderabad – Saffron Rise
						</h2>
				...
				<!-- <div class="col-md-6">
					<div class="section-image">
						<div class="feature-image">
							<img src="images/saffron-rise--4.jpeg" alt="project-img">
						</div>
					</div>
				</div> -->
				<div class="col-md-12">
