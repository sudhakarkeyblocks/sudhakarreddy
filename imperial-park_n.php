...
if (!empty($_POST)) {
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'Project Leads - imperial Park';
...
<head>
	...
	<meta name="description" content="Imperial Park Township in Darbhanga is a vision for modern city living where meaningful connections are formed with those around you. Contact us today for more details."/>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="project-content">
						<h2>Buy Open Plots in Darbhanga, Bihar at Imperial Park Projects
						</h2>
						<ul class="project-data-list">
							...
							<li>
								...
								<span class="data-text">
									<a href="assets/Broucher/Imperial-Park.pdf"
