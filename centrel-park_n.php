...
if (!empty($_POST)) {
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'Project Leads - Central Park';
...
<head>
	...
	<meta name="description" content="Buy a properrty at Central park offered by Tricolour properties located in the heart of Darbhanga, Situated close to the NH27 East-West corridor."/>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="project-content">
						<h2>Open Plots at Central Park Project at Dharbhanga
						</h2>
						<ul class="project-data-list">
							...
							<li>
								...
								<span class="data-text">
									<a href="assets/Broucher/Central-Park.pdf"
