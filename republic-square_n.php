...
if (!empty($_POST)) {
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'Project Leads - Republic Square';
...
<head>
	...
	<meta name="description" content="Explore Republic Square's residential plots at Karza, Muzaffarpur. Discover the perfect space to build your dream home in a thriving community. Explore now"/>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="project-content">
						<h2>Residential / Open Plots at Karza, Muzaffarpur.
						</h2>
				...
				<!-- <div class="col-md-6">
					<div class="section-image">
						<div class="feature-image">
							<img src="images/republic-square-1.jpeg" alt="project-img">
						</div>
					</div>
				</div> -->
				<div class="col-md-12">
