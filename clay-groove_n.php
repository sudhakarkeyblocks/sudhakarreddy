...
if (!empty($_POST)) {
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'Project Leads - Clay Groove';
...
<head>
	...
	<title> Residential open plots for sale at Clay groov Bengaluru.</title>
	<meta name="description" content="Buy a beautiful residential open plots for sale in Clay groov Bangalore. Tricolour properties offers affordable prices on open plots for future investments."/>
			...
			<div class="row" style="margin-bottom: 50px; margin-top: 60px;">
				...
				<div class="col-md-4 pl-0 formE1" style="background-color: #0A0a0a;">
					...
					<form class="form" method="post">
						...
						<button type="submit" name="p_submit" id="submit" class="btn1">Submit</button>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="project-content">
						<h2>Residential Open Plots for Sale at Clay Groov Bengaluru.
						</h2>
				...
				<!-- <div class="col-md-6">
					<div class="section-image">
						<div class="feature-image">
							<img src="images/claygroove-gallery-1.jpg" alt="project-img">
						</div>
					</div>
				</div> -->
				<div class="col-md-12">

					<!-- <h3>Explore Ideal Clay Groove: 
						</h3> 
						<P>Connectivity, Key Projects, Economic Value, and Future Prospects.</P> -->
