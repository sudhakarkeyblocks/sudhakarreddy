...
if (!empty($_POST)) {
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'Project Leads - Coral Bay';
...
<head>
	...
	<meta name="description" content="Buy plot with world class aminities at  Corol bay, Vishakapatnam. The venture is in quite unpolluted place-Nathavalasa junction-apart . Call now to book a plot."/>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="project-content">
						<h2>Tricolour Properties – Open Plots in Corals Bay, Visakhapatnam
						</h2>
				...
				<!-- <div class="col-md-6">
					<div class="section-image">
						<div class="feature-image">
							<img src="images/coral-bay-1.jpg" alt="project-img">
						</div>
					</div>
				</div> -->
				<div class="col-md-12">
