...
if (!empty($_POST)) {
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'Project Leads - Blue Heaven';
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="project-content">
										<h2>Buy New Residential Plots On Blue Heaven Hyderabad – Nagpur Highway
										</h2>
										<ul class="project-data-list">
											...
											<li>
												...
												<span class="data-text">
													<a href="assets/Broucher/Blue-Heaven.pdf"
								...
								<!-- <div class="col-md-6">
									<div class="section-image">
										<div class="feature-image">
											<img src="images/blue-heaven-gallery-1.jpeg" alt="project-img">
										</div>
									</div>
								</div> -->
								<div class="col-md-12">
