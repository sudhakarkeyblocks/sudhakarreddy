		...
		<div class="single-project-conten">
			...
			<div class="col-md-6 ">
				...
				<p>We give you multiple reasons on why one should own a property at Tricolour.</p>
								...
								<p>
									   <input class="inp1" name="name" type="text" placeholder="Name" required />
								 </p>
								
								 <p>
									   <input class="inp1" placeholder="Email Id" name="email" type="email" required />
								 </p>
								 <p>
									<input  class="inp1" placeholder="Phone Number" name="phonenumber" type="tel" required />
								 </p>
								 <p>
									<input class="inp1" placeholder="Designation" name="designation" type="text" required />
								 </p>
								 <p>
									<input class="inp1" placeholder="Skills" name="skills" type="text" required />
								 </p>
								 <p>
									<input class="inp1" placeholder="Message" name="message" type="text" required />
								 </p>
								 <p>
									 <!-- <input name="resume"  type="file" accept=".doc,.pdf,.docx" placeholder="Resume" style="background-color: #000;" required > -->
									 <input class="inp1" type="url" name="resume" placeholder="paste your pdf link"> <br>
									 <span>
										Note: <br>
