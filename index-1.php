...
<div id="ip-container" class="ip-container">
			...
			<div class="header-line">
				...
				<div class="social-line">
					<ul class="social-list">
						<li>
							<a href="https://www.facebook.com/TricolourGroup"><i class="fab fa-facebook-square"></i></a>
						</li>
						<li>
							<a href="https://www.instagram.com/tricolourgroup/"><i class="fab fa-instagram"></i></a>
						</li>
						
						<li>
							<a href="https://www.linkedin.com/company/tricolourgroup/"><i class="fab fa-linkedin"></i></a>
						</li>
						<li>
							<a href="https://api.whatsapp.com/send?phone=+919611275001&text=Hi."><i class="fab fa-whatsapp"></i></a>
						</li>
						<li>
							<a href="https://www.youtube.com/channel/UCc4NY-q_WUBOZoR2B3Q_U9g"><i class="fab fa-youtube"></i></a>
						</li>
					</ul>
				</div>
  ...
  <div style="transform: translate(50%.50%); left: 44%;" class="swiper-button-prev swiper-button-white"></div>
  <div  style="transform: translate(50%.50%)" class="swiper-button-next swiper-button-white"></div>
    <!-- <div style="transform: translate(50%.50%)" class="swiper-button-prev swiper-button-white"></div>
    <div style="transform: translate(50%,50%); "  class="swiper-button-prev swiper-button-white"></div> -->


  <!-- <div style="opacity: 1; transform: translate(-65px, -70px); top: 100%; left: 50%;" class="swiper-button-prev swiper-button-white"></div> -->
  <!-- <rs-arrow style="opacity: 1; transform: translate(-5px, -70px); top: 100%; left: 50%;" class="swiper-button-next swiper-button-white"></rs-arrow> -->
						...
						<div class="row g-0">
							<div class="col-lg-3">
								<div class="services-post3">
									...
									<h4 class="counter-count" >13</h4>
									<p style="color: red; font-size: 16px;">Years of Excellence</p>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="services-post3">
									<i class="fas fa-home"></i>
									<h4 class="counter-count" >35</h4>
									<p style="color: red; font-size: 16px;">Projects Completed</p>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="services-post3">
									<i class="far fa-smile"></i>
									<h4 class="counter-count"  >30000</h4>
									<p style="color: red; font-size: 16px;">Happy Customers</p>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="services-post3">
									<i class="fas fa-map-marker-alt"></i>
									<h4 class="counter-count" >7</h4>
									<p style="color: red; font-size: 16px;">Across Locations</p>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="portfolio-box iso-call">
									...
									<div class="portfolio-post">
										<figure class="effect-milo">
											<img src="images/Palm-Cove-New-Banner.jpg" alt=""/>
											<figcaption>
												<p>Hyderabad</p>
												<h4><a href="palm-clove.php">Palm Cove</a></h4>
												<a href="assets/Broucher/Palm-Cove-New-rates_brocher.pdf" target="_blank">
													<span>
                                    ...
                                    <div class="portfolio-post">
										<figure class="effect-milo">
											<img src="images/summer-brook-new-banner.jpeg" alt=""/>
											<figcaption>
												<p>Darbhanga</p>
												<h4><a href="summer_brook.php">Summer Brook</a></h4>
												<a href="assets/Broucher/Summer_Brook_compressed.pdf" target="_blank">
													<span>
														<i class="fa fa-download" aria-hidden="true"></i>
													</span>
												</a>
										...
										<div class="portfolio-post">
										<figure class="effect-milo">
											<img src="images/Pleasure-Bay-New-Banner.jpg" alt=""/>
											<figcaption>
												<p>Visakhapatnam</p>
												<h4><a href="pleaseure_by_vizag.php">Pleasure Bay</a></h4>
												<a href="assets/Broucher/Pleasure-Bay.pdf" target="_blank">
													<span>
														<i class="fa fa-download" aria-hidden="true"></i>
													</span>
												</a>
									...
									<div class="portfolio-post">
										<figure class="effect-milo">
											<img src="images/spring-fields-banner-new.jpg" alt=""/>
											<figcaption>
												<p>Patna</p>
												<h4><a href="spring-comos.php">Spring Fields</a></h4>
									...
									<div class="portfolio-post">
										<figure class="effect-milo">
											<img src="images/Sunflower-New-Banner.jpg" alt=""/>
											<figcaption>
												<p>Bangalore</p>
												<h4><a href="sun-flower.php">Sunflower</a></h4>
												<a href="assets/Broucher/Sunflower.pdf">
													<span>
														<i class="fa fa-download" aria-hidden="true"></i>
													</span>
												</a>
									...
									<div class="portfolio-post">
										<figure class="effect-milo">
											<img src="images/oscar-valley-new-banner.jpg" alt=""/>
											<figcaption>
												<p>Mumbai</p>
												<h4><a href="oscar-valley.php">Oscar Valley</a></h4>
												<a href="assets/Broucher/Oscar-Valley-Brochure_3-revised-price.pdf">
													<span>
														<i class="fa fa-download" aria-hidden="true"></i>
													</span>
												</a>
							...
							<div class="col-lg-6">
								...
								<div class="services-post5">
									...
									<div class="serv-content">
										...
										<p>ATricolour Properties boasts a long history of completing real estate projects successfully, demonstrating our expertise and reliability.
										</p>
									</div>
								</div>
						...
						<div class="row">
							...
							<div class="col-lg-6 custom-about-box">
								<div class="about-content">
									...
									<a class="button-one" href="#"><span>Know More</span></a>
								</div>
							</div>
						</div>
					</div>
			...
			<section class="services-section2">
				...
				<div class="container">
					<div class="title-box center-title">
						<span class="custom-sub-title">TRICOLOR PROPERTIES</span>
						<h2>Why Choose Us</h2>
					</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="services-post2">
									...
									<div class="serv-content">
										<h4>Planning</h4>
										<p>We have carefully planned & designed layout of the projects to augment a smart lifestyle for our customers.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
			...
			<section class="services-section4">
				...
				<div class="services-box4">
					<div class="services-post4">
						<img src="images/416x400__.jpg" alt="service1" class="image">
						<div class="overlay">
					...
					<div class="blog-box iso-call row">
						...
						<div class="blog-post">
							...
							<div class="post-content">
								...
								<h3><a href="#">The Best Cities for First-Time Homebuyers in 2023</a></h3>
								
								<a class="button-one" href="#"><span>Read More</span></a>
							</div>
						</div>
						</div>
						<div class="col-lg-3">
						<div class="blog-post">
							...
							<div class="post-content">
								...
								<h3><a href="#">Timing is the Key: When Is the Best Time to Invest in Real Estate Properties?</a></h3>
						...
						<div class="blog-post">
							...
							<div class="post-content">
								...
								<h3><a href="#">A Guide to Understanding Vaastu Shastra and its Impact in Home and Property Buying.</a></h3>
								
								<a class="button-one" href="single-post.php"><span>Read More</span></a>
							</div>
						</div>
						</div>
						<div class="col-lg-3">
						<div class="blog-post">
							...
							<div class="post-content">
								...
								<h3><a href="#">What is Dharani Portal and why we should know about it?</a></h3>
			...
			<footer class="template-footer">
				...
				<div class="widget-part-area">
					...
					<div class="footer-widget-line">
						...
						<h5>Enquiry</h5>
						<ul class="custom-list">
							<li><a href="#">contact@tricolour.co.in</a></li>
							<li><a href="#">1800-120-5153</a></li>
						</ul>
					</div>
					<div class="footer-widget-line">
								...
								<form id="contact-form">
									<h4>Send message</h4>
											...
											<div class="input-line">
												...
												<input name="phone" id="website" type="text" placeholder="Phone Number">
											</div>

											<div class="input-line">
												<label for="projects">Query</label>
												<input name="projets" id="projects" type="text" placeholder="">
												<!-- <select name="mail" class="footer-projets">
