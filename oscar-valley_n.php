...
if (!empty($_POST)) {
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'Project Leads - Oscar Valley';
...
<head>
	...
	<meta name="description" content="Open plots or land for sale at Oscar valley Mumbai would be a very good opportunity for you to invest. Contact us today for further details."/>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="project-content">
						<h2>Residential / Open Plots at Virar Mumbai in Oscar Valley Project
						</h2>
				...
				<!-- <div class="col-md-6">
					<div class="section-image">
						<div class="feature-image">
							<img src="images/oscar-valley-1.jpg" alt="project-img">
						</div>
					</div>
				</div> -->
				<div class="col-md-12">
