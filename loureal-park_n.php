...
if (!empty($_POST)) {
   ...
   if (empty($errors)) {
       ...
       $emailSubject = 'Project Leads - Loureal Park';
...
<head>
	...
	<meta name="description" content="Loureal park residential open plots for sale near Yadagirigutta, Sri Lakshmi Narasimha Swamy Temple. The property provides an ideal living environment with convenient amenities: Satisfies your retail needs .Contact now."/>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="project-content">
						...
						<h2>Buy Now Loureal Park Residential Open Plots Situated Near Yadagirigutta.
				...
				<!-- <div class="col-md-6">
					...
					<div class="section-image">
						...
						<div class="feature-image">
							...
							<img src="images/loreal-park-one.jpg" alt="project-img">
