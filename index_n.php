			...
			<section class="services-section3">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div class="hmr_bnr">
								<form  class="row justify-content-center center-title">
									<div class="col-md-3">
									...
									<div class="col-md-2">
										<input type="submit" name="submit" value="Submit" class="btn btn-primary frm_btn">
									</div>
								</form>
							</div>
						</div>
  ...
  <div class="widget-part-area">
    ...
    <div class="footer-widget-line">
      ...
      <ul class="custom-list">
        ...
        <li>
          <a href="all-projects.php">Download e-brochure</a>
        </li>
      </ul>
    ...
    <form  method="post">
                     ...
                     <p>
                       <input name="if_name" type="text" placeholder="Name"/>
                     </p>
                     <p>
                       <input  placeholder="Email Id" name="if_email" type="text"/>
                     </p>
                     <p>
                        <input  placeholder="Phone Number" name="if_phonenumber" type="text"/>
                     </p>
                     <p>
                       <input name="if_message" type="text" placeholder="Your Query"/>
                     </p>
                     <!-- <p>
